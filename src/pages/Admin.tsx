                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                <option value="gpt-4o-mini">GPT-4o-Mini (Não recomendado para base de conhecimento)</option>
                                <option value="gpt-3.5-turbo">GPT-3.5-Turbo</option>
                            </select>
                            {selectedKnowledgeBase && assistantConfig.model === 'gpt-4o-mini' && (
                                <p className="mt-1 text-sm text-red-500">
                                    ⚠️ O modelo GPT-4o-Mini não é recomendado para uso com base de conhecimento. Para melhor desempenho, use GPT-4o ou GPT-4-Turbo.
                                </p>
                            )}
                        </div>
                        <div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="border rounded-lg p-4">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium">OCR / Vision API (GPT-4o Mini)</h3>
                                <div className="flex items-center">
                            ...
                            <div className="mb-4">
                                <p className="text-sm text-gray-700 mb-2">
                                    O custo do OCR via Vision API é baseado na qualidade da análise e no tamanho da imagem:
                                </p>
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <p className="text-sm text-gray-500">Baixa Resolução (detail: low)</p>
                                    <p className="text-lg">85 tokens por imagem</p>
                                    <p className="text-xs text-gray-500">Custo fixo independente do tamanho</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Alta Resolução (detail: high)</p>
                                    <p className="text-lg">85 tokens + 170 tokens por tile</p>
                                    <p className="text-xs text-gray-500">Imagem é dividida em tiles de 512px</p>
                                </div>
                            </div>
                            <div className="mt-4 p-3 bg-gray-50 rounded-lg text-sm">
                                <p className="font-medium mb-2">Exemplos de custo em Alta Resolução:</p>
                                <ul className="list-disc pl-5 space-y-1">
                                    <li>Imagem 1024x1024: 765 tokens (4 tiles × 170 + 85)</li>
                                    <li>Imagem 2048x4096: 1105 tokens (6 tiles × 170 + 85)</li>
                                </ul>
                                <p className="mt-2 text-xs text-gray-500">
                                    Atualmente utilizamos sempre Alta Resolução para melhor qualidade de extração.
                                </p>
                            </div>
                        </div>
